...
class AccountRegistrationWindow(ctk.CTk):
    def __init__(self, list_of_currencies: list[str], bank):
        ...
        self.entries_frame.grid_rowconfigure((0,1,3), weight=1)
        ...
        self.interest_rate_optionmenu.grid(row=0, column=1)
        ...
        self.amount_entry.grid(row=2, column=1, padx=10, pady=(10,10))
